...
import companyLogo from '../images/starfall-logo.svg';
...
function Sidebar({
  ...
  return (
    <div>
      ...
      <div
        className={`fixed inset-0 bg-mystic-violet-900 bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-mystic-violet-800 p-4 transition-all duration-200 ease-in-out ${
      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <img className="mt-3" src={companyLogo} alt="logo" />
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Messages */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('messages') && 'bg-mystic-violet-900'}`}>
                <NavLink
                  end
                  to="/messages"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
              ...
              {/* Inbox */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-mystic-violet-900'}`}>
                <NavLink
                  end
                  to="/inbox"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
              ...
              {/* Calendar */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('calendar') && 'bg-mystic-violet-900'}`}>
                <NavLink
                  end
                  to="/calendar"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
              ...
              {/* Campaigns */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('campaigns') && 'bg-mystic-violet-900'}`}>
                <NavLink
                  end
                  to="/campaigns"
                  className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
