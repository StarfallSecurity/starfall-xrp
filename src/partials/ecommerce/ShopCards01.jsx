...
function ShopCards01(props) {
  ...
  return (
    <React.Fragment>
      {nfts.map(nft => {
        return (
            <div className="col-span-full sm:col-span-6 xl:col-span-3 bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden cursor-pointer" onClick={() => {window.open(nft.asset_url, '_blank', 'noopener,noreferrer')}}>
              <div className="flex flex-col h-full">
                {/* Image */}
                <img className="w-full" src={nft.asset_img_url} width="286" height="160" alt="Application 01" />
                {/* Card Content */}
                <div className="grow flex flex-col p-5">
                  ...
                  <div className="grow">
                    ...
                    <header className="mb-3">
                      <h3 className="text-lg text-slate-800 font-semibold">{nft.asset_name}</h3>
                    </header>
                    {/* Rating and price */}
                    <div className="flex flex-wrap justify-between items-center mb-4">
                      ...
                      {/* Price */}
                      <div>
                        <div className="inline-flex text-sm font-medium bg-emerald-100 text-emerald-600 rounded-full text-center px-2 py-0.5">{nft.event_total_price} {nft.event_payment_symbol}</div>
                      </div>
                    </div>
                    {/* Features list */}
